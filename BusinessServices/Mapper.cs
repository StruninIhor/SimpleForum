...
namespace BusinessServices
{
    ...
    {
        public static bool IsSimpleType(this Type type) => type.IsPrimitive || type.Equals(typeof(string));

        //TODO Implement simple type checking
        /// <summary>
        /// Maps one object to another if fields name are the same and they are not in notIncludedProerties 
        /// </summary>
